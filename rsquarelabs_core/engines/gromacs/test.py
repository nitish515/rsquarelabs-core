...
class GromacsTest(BaseClass):
    ...
    def gromacs_obj(self):
        print "gromacs_test3"
        time.sleep(2)

        self.project_test = self.select_project()
        self.run_id = self.select_run()
        return Gromacs(project_id=self.project_test[0],
